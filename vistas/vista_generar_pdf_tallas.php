...
<html >
<head>
  <title>Reporte de todas las tallas</title>
  <meta charset="utf-8">
...
<body> 
	<div><img src="assets/images/cintillo.jpg" height="50" width="100%" >
          <center><h3>reporte de todas las tallas de uniformes registradas en el sistema.</h3></center>
          <center><h4>listado de chaqueta por tallas.</h4></center>
          <table>
          <thead>
              <tr>
                  <th>XS</th>
          ...
          foreach ($atletat as $key => $at) { 
            $atleta = $Oatleta->consultarDatos($at['cedula_atleta']);?>
                <?php switch ($atleta['talla_chaqueta']) {
                    case 'XS':
                        $XS=$XS+1;
                        break;
                    case 'S':
          ...
          <center><h4>listado de gorras por tallas.</h4></center>
          <table>
          <thead>
              <tr>
                  <th>XS</th>
          ...
          <center><h4>listado de pantalon por tallas.</h4></center>
          <table>
          <thead>
              <tr>
                  <th>XS</th>
          ...
          <center><h4>listado de Shorts por tallas.</h4></center>
          <table>
          <thead>
              <tr>
                  <th>XS</th>
          ...
          <center><h4>listado de zapatos por tallas.</h4></center>
          <table>
          <thead>
              <tr>
        ...
        }else{echo "1er lapso ".date('Y')." (Enero-Junio)";} ?>.</h4></center></p><br/><br/><br/>
          <center><h3>_______________________________________</h3></center>
        <center><strong>Lcdo Alfredo Perez.</strong></center>
        <center><strong>Jefe de la Dirección de deportes.</strong></center>
...
$dompdf->render();
$pdf = $dompdf->output();
$filename =  'Reporte de uniformes por tallas '.$fecha1.'.pdf';
