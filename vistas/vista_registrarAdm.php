...
<body>
                                ...
                                <div class="panel-body">
                                    <form action="" method="post" role="form" id=userForm>
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input name="username" type="text" id="username" class="form-control" pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{3,20}$" title="El nombre de usuario debe contener al menos 4 caracteres, no puede empezar con un caracter numerico ni contener espacios" placeholder="Nombre de Usuario" autocomplete="off" maxlength="10" required/>
                                        </div>
                                        <div class="form-group input-group alert alert-success" id= "usernameD" style="display:none; ">
                                            <span  > Nombre de usuario disponible</span>
                                        </div>
                                        <div class="form-group input-group alert alert-danger" id= "usernameND" style="display:none; ">
                                        ...
                                        <div class="form-group input-group">
                                            ...
                                            <input name="pass" id="pass" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Debe contener al menos un número y una letra mayúscula y minúscula, y al menos 8 o más caracteres" autocomplete="off" class="form-control" placeholder="Contraseña" required />
                                        </div>
                                        <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-lock"  ></i></span>
                                            <input name="rpass" id="rpass" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Debe contener al menos un número y una letra mayúscula y minúscula, y al menos 8 o más caracteres" autocomplete="off" class="form-control" placeholder="Repita la contraseña" required />
                                        </div>
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="div-general-img">
                                                        <?php foreach ($arr as $key => $value) {
                                                            ...
                                                            <input type="radio" name="imgValid" value="'.$value.'" class="hidden" >
                                                            </label>
                                                            </div>';
                                                        }
                                                        ?>
                                                    </div>
                                                     <input type="hidden" name="foto_valor" id="foto_valor">
                                        ...
                                        <div class="form-group input-group">
                                            <button name="submit" id="btnRegistrar" value="registrarAdm" type="submit" class="btn btn-success">Registrar</button>
    ...
    <script type="text/javascript">
        ...
        $('input[name=imgValid]').change(function(event,ui) {
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $("#username").keyup(function(event){
                ...
                if (name.length>3){
                    $.post('ajax/validarUsuario.php', $("#userForm").serialize(), function(respuesta){
                        //alert(respuesta); 
                        if (respuesta == 'false') {
                            $("#usernameD").fadeIn();
                            $("#usernameND").fadeOut();  
