            ...
            <div id="page-inner">
                ...
                <?php if (isset($borrado)&&$borrado==1) {?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        El PNF se ha <strong>eliminado correctamente!</strong>
                    </div>
                <?php } ?>
                <?php if (isset($actualizo)&&$actualizo==1) {?>
                    <div class="alert alert-info alert-dismissible">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        Los datos han sido <strong> modificados exitosamente!</strong>
                    </div>
                <?php } ?>
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        <thead>
                                            <tr>
                                                <th>Nombre de los PNF</th>
                                                <th>Nombre de los Coordinadores</th>
                                                <th> </th>
                                                <th> </th>
                                            </tr>
                                        </thead>
                                        <tbody><?php foreach ($todos as $au){ ?>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td><?php echo $au['coordinador']; ?></td>
                                                

                                                <td class="center">
                                                    <?php $uid= $au['id_pnf']; ?>
                                                    <!-- Boton para activar el modal MODIFICAR -->
                                                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#myModal" data-id="<?php echo "?action=modificarPnf&id_pnf=".$uid; ?>">Modificar</button>
                                                </td>
                                                <td class="center">
                                                            ...
                                                            <div class="modal-dialog modal-sm" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>¿Estas segur@ que quieres modificar al PNF?</p>
                                                          ...
                                                          <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModal2">
                                                            <div class="modal-dialog modal-sm" role="document">
                                                              <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>¿Estas segur@ que quieres eliminar al PNF?</p>
