...
<html >
<head>
  <title>Reporte por talla y peso</title>
  <meta charset="utf-8">
...
<body> 
	<div><img src="assets/images/cintillo.jpg" height="50" width="100%" >
          ...
          <center><h3>listado de atletas en un rango de Estatura de <?php echo $_POST['estaturamin']." al ".$_POST['estaturamax'];?> y Peso de <?php echo $_POST['pesomin']." al ".$_POST['pesomax'];?>.</h3></center><br/>
          <table>
          <thead>
              <tr>
                  <th>Nombre</th>
          ...
          <tbody><?php foreach ($atletatp as $key => $atp) { 
            $atleta = $Oatleta->consultarDatos($atp['cedula_atleta']);?>
                <tr>
                    ...
                    ?></th>
                    <th><?php echo $atp['estatura']; ?></th>
                    <th><?php echo $atp['peso']; ?></th>
...
$dompdf->render();
$pdf = $dompdf->output();
$filename =  'Reporte por rango de estaura y peso '.$fecha1.'.pdf';
